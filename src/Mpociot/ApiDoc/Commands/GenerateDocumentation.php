...
class GenerateDocumentation extends Command
{
    ...
    protected $signature = 'api:generate
                            ...
                            {--swaggerCollection : Disable Postman collection creation}
    ...
    public function handle()
    {
        ...
        if ($this->option('router') === 'laravel') {
            $generator = new LaravelGenerator($this->config, $this->option('swaggerCollection'));
        } else {
            $generator = new DingoGenerator($this->config, $this->option('swaggerCollection'));
        }
    ...
    private function writeMarkdown($parsedRoutes)
    {
        ...
        if ($this->option('noPostmanCollection') !== true) {
            ...
            if ($this->option('swaggerCollection') === true) {
    ...
    private function isRouteVisibleForDocumentation($route)
    {
        ...
        try {
            ...
            throw new \ReflectionException("【{$class}】" . $e->getMessage());
        }
        if ($comment) {
