...
namespace Mpociot\ApiDoc\Strategies\CookieParameters;
...
class GetFromCookieParamTag extends Strategy
{

    public function getCookieParametersFromDocBlock($tags)
    {
        $parameters = collect($tags)
            ->filter(function ($tag) {
                return $tag instanceof Tag && $tag->getName() === 'cookieParam';
            })
